...
const HOT_DRINKS: MenuRow[] = [
  ...
  { id: 'double-espresso', name: 'Double Espresso', price: '£2.80', addable: { name: 'Double Espresso', price: 2.8 } },
  { id: 'flat-white', name: 'Flat White', price: '£3.40', addable: { name: 'Flat White', price: 3.4 } },
  { id: 'latte', name: 'Latte', price: '£3.40 / £3.70 / £3.90', desc: 'Small / Medium / Large', addable: { name: 'Latte (M)', price: 3.7 } },
  { id: 'cappuccino', name: 'Cappuccino', price: '£3.40 / £3.70 / £3.90', addable: { name: 'Cappuccino (M)', price: 3.7 } },
  { id: 'americano', name: 'Americano', price: '£3.20 / £3.70', addable: { name: 'Americano', price: 3.2 } },
  { id: 'mocha', name: 'Mocha', price: '£3.30 / £3.80 / £4.00', addable: { name: 'Mocha (M)', price: 3.8 } },
  { id: 'hot-choc', name: 'Hot Chocolate (ve)', price: '£3.50 / £3.90', addable: { name: 'Hot Chocolate', price: 3.5 } },
  { id: 'deluxe-hot-choc', name: 'Deluxe Hot Chocolate', price: '£4.60 / £4.90', desc: 'with cream & marshmallows', addable: { name: 'Deluxe Hot Chocolate', price: 4.6 } },
  { id: 'iced-latte', name: 'Iced Latte', price: '£4.80', addable: { name: 'Iced Latte', price: 4.8 } },
  { id: 'matcha', name: 'Matcha', price: '£3.90 / £4.30', addable: { name: 'Matcha', price: 3.9 } },
  { id: 'chai', name: 'Chai Tea Latte (ve)', price: '£3.90 / £4.30', addable: { name: 'Chai Latte', price: 3.9 } },
  { id: 'turmeric', name: 'Turmeric Latte (ve)', price: '£3.90 / £4.30', addable: { name: 'Turmeric Latte', price: 3.9 } },
  { id: 'tea', name: 'Pot of Tea', price: '£2.90', addable: { name: 'Pot of Tea', price: 2.9 } },
]

const BREAKFAST: MenuRow[] = [
  { id: 'farmhouse-toast', name: 'Farmhouse toast & butter', price: '£3.30', addable: { name: 'Farmhouse toast', price: 3.3 } },
  { id: 'tea-bread', name: 'Toasted tea bread & butter', price: '£3.40', addable: { name: 'Tea bread', price: 3.4 } },
  { id: 'scrambled-egg', name: 'Scrambled egg on toast (v)', price: '£5.40', addable: { name: 'Scrambled egg on toast', price: 5.4 } },
  { id: 'beans-toast', name: 'Beans on toast (v)', price: '£5.40', addable: { name: 'Beans on toast', price: 5.4 } },
  { id: 'bacon-roll', name: 'Large bacon roll', price: '£6.30', desc: 'staff favourite', addable: { name: 'Bacon roll', price: 6.3 } },
  { id: 'avocado-toast', name: 'Smashed avocado on ciabatta', price: '£6.00', addable: { name: 'Avocado toast', price: 6.0 } },
  { id: 'eggs-benedict', name: 'Eggs Benedict — Classic Bacon', price: '£11.50', desc: 'served until 12pm', addable: { name: 'Eggs Benedict', price: 11.5 } },
  { id: 'eggs-royale', name: 'Eggs Royale — Smoked Salmon', price: '£13.50', addable: { name: 'Eggs Royale', price: 13.5 } },
]

const LUNCH: MenuRow[] = [
  { id: 'panini-classic', name: 'Classic Panini', price: '£8.50', desc: 'ham & cheese · with crisps & salad', addable: { name: 'Classic Panini', price: 8.5 } },
  { id: 'panini-veggie', name: 'Veggie Panini', price: '£8.50', desc: 'spinach, mushrooms & cheese', addable: { name: 'Veggie Panini', price: 8.5 } },
  { id: 'panini-meat', name: 'Meat Feast Panini', price: '£9.00', desc: 'chicken, chorizo, bacon & cheese', addable: { name: 'Meat Feast Panini', price: 9.0 } },
  { id: 'jacket-cheese', name: 'Jacket Potato — Cheese', price: '£8.20', addable: { name: 'Jacket — Cheese', price: 8.2 } },
  { id: 'jacket-tuna', name: 'Jacket Potato — Tuna mayo', price: '£8.40', addable: { name: 'Jacket — Tuna', price: 8.4 } },
  { id: 'salad-meaty', name: 'Salad Bowl — Chicken & Chorizo', price: '£7.80', addable: { name: 'Meaty Salad', price: 7.8 } },
  { id: 'soup', name: 'Tomato & basil soup', price: '£6.50', desc: 'with 3 slices ciabatta', addable: { name: 'Soup', price: 6.5 } },
]
...
const RECIPES: Recipe[] = [
  { id: 'r-espresso', name: 'Espresso', group: 'Classics', ingredients: ['espresso'], blurb: 'The single shot that anchors every milk drink on the menu.' },
  { id: 'r-cappuccino', name: 'Cappuccino', group: 'Classics', ingredients: ['espresso', 'steamed milk', 'foamed milk'], blurb: 'Equal parts espresso, steamed milk and dense foam.' },
  { id: 'r-flatwhite', name: 'Flat White', group: 'Classics', ingredients: ['espresso', 'steamed milk'], blurb: 'A double ristretto under silky microfoam — Antipodean classic.' },
  { id: 'r-latte', name: 'Latte', group: 'Classics', ingredients: ['espresso', 'steamed milk', 'foamed milk'], blurb: 'Long, mellow and milky — perfect for first-thing mornings.' },
  { id: 'r-mocha', name: 'Mocha', group: 'Classics', ingredients: ['espresso', 'steamed milk', 'chocolate'], blurb: 'A latte with a hit of dark chocolate. Cosy in cup form.' },
  { id: 'r-macchiato', name: 'Macchiato', group: 'Classics', ingredients: ['espresso', 'foamed milk'], blurb: 'Espresso "stained" with a teaspoon of foam.' },
  { id: 'r-pumpkin', name: 'Pumpkin Spice Latte', group: 'Seasonal', ingredients: ['espresso', 'steamed milk', 'pumpkin syrup', 'spice'], blurb: 'Autumn in a cup — cinnamon, nutmeg, clove.' },
  { id: 'r-iced', name: 'Iced Coffee', group: 'Seasonal', ingredients: ['cold brew', 'ice', 'milk (optional)'], blurb: 'Slow-steeped 18 hours, poured long over ice.' },
  { id: 'r-frappe', name: 'Frappé', group: 'Seasonal', ingredients: ['espresso', 'sugar', 'ice', 'milk'], blurb: 'Greek-style shaken iced coffee with a thick foamy head.' },
  { id: 'r-cortado', name: 'Cortado', group: 'Around the world', ingredients: ['espresso', 'steamed milk'], blurb: 'Spanish 1:1 espresso to milk — bold but balanced.' },
  { id: 'r-affogato', name: 'Affogato', group: 'Around the world', ingredients: ['espresso', 'vanilla ice cream'], blurb: 'A scoop of gelato "drowned" in fresh espresso.' },
  { id: 'r-yuanyang', name: 'Yuanyang', group: 'Around the world', ingredients: ['coffee', 'milk tea'], blurb: 'Hong Kong street favourite — coffee meets milk tea.' },
]
...
const TESTIMONIALS = [
  ...
  {
    quote:
      "Bottomless brunch beat my expectations — and I had high ones. Eggs Royale was perfect.",
    name: 'Lucia H.',
  ...
  return (
    <div className="ai-card">
      ...
      {busy ? (
        ...
        <div className="score">
          We suggest <strong>{best.name}</strong> · match{' '}
...
function ChatBot({
  ...
  return (
    <div
      className={`chat-dock persona-${persona.id}`}
      role="dialog"
    ...
    >
      ...
      <div className="body">
        <ChatWindow
          ...
          placeholder={token ? `Ask ${persona.label.split(' ')[0]} anything…` : 'Paste your HF token above first'}
        />
      </div>
    </div>
  )
...
function Footer() {
  return (
    <footer>
      Built with{' '}
      <a href="https://www.npmjs.com/org/neurova">neurova.js v2.2.2</a> · imagery
      by{' '}
      <a href="https://www.pexels.com" target="_blank" rel="noreferrer">Pexels</a>{' '}
      · chat by{' '}
      <a href="https://huggingface.co" target="_blank" rel="noreferrer">Hugging Face</a>{' '}
      · © 2026 Bean &amp; Brew
    </footer>
  )
}
    ...
    <>
      <section className="container hero">
        <div>
          ...
          <p className="lead">
            Single-origin beans, house-baked pastries and a sunlit corner to
            call your own. Order ahead — your cup will be waiting on the counter.
          </p>
          <div className="cta">
      ...
      <section className="container section">
        <div className="stats">
          <div className="stat"><div className="n">12</div><div className="l">single-origin beans</div></div>
          <div className="stat"><div className="n">4.9★</div><div className="l">2,300+ reviews</div></div>
          <div className="stat"><div className="n">7am</div><div className="l">opens daily</div></div>
          <div className="stat"><div className="n">100%</div><div className="l">compostable cups</div></div>
        </div>
      </section>
        ...
        <div className="visit-grid">
          <div className="visit-card">
            ...
            <img
              ...
              style={{ width: '100%', borderRadius: 16, marginTop: 18, aspectRatio: '16/9', objectFit: 'cover' }}
            />
          </div>
          <div className="hours">
            <h3>Opening hours</h3>
            <table>
              <tbody>
                ...
                <tr><td>Friday</td><td>07:00 – 19:00</td></tr>
                <tr><td>Saturday</td><td>08:00 – 19:00</td></tr>
                <tr><td>Sunday</td><td>09:00 – 16:00</td></tr>
              </tbody>
            </table>
            <p className="note">
              Bottomless brunch every Sat/Sun, 10am – 1pm · £29pp
            </p>
          </div>
        </div>
      </section>
    ...
    <>
      <section className="container page-hero">
        <div>
          ...
          <p className="lead">
            Every coffee pulled to order. Tap <code>+</code> to add to your cart —
            state syncs everywhere via <code>createStore</code> +{' '}
            <code>useStore</code>.
          </p>
          <div className="cta">
            <Button
    ...
    <>
      <section className="container page-hero">
        <div>
          ...
          <p className="lead">
            We roast every Tuesday in small 12 kg batches, working directly with
            four farms across Africa and South America. Ask Sage — our
            sommelier — for brew ratios and tasting notes.
          </p>
        </div>
        <div className="hero-art">
      ...
      <section className="container section">
        <h2>Our origins</h2>
        <p className="sub">
          Four single-origins on rotation. Each is sold whole-bean by the 250 g
      ...
      <section className="container section">
        ...
        <p className="sub">
          Curious how the magic happens? Here's how our baristas pull every
          drink on the menu.
        </p>
        {(['Classics', 'Seasonal', 'Around the world'] as const).map((group) => (
          <div key={group} style={{ marginBottom: 28 }}>
            <h3 style={{ margin: '8px 0 14px', color: 'var(--brand-strong)' }}>
              {group}
            </h3>
